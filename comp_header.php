...
<body oncontextmenu="toggle_menu(); return false">
  ...
  <div id="menu_container" onclick="toggle_menu()">
    <div id="menu">
      <div id="menu">
        <div id="menu_top">
          <a class="menu_item" onclick="toggle_module()">
            ...
            <p><?= $dictionary[$language . '_sign_in'] ?></p>
          </a>
        </div>
        <div id="menu_mid">
          <a class=<?php if ($_title == 'Momondo') {
                      echo 'current_page';
                    } else {
                      echo 'menu_item';
            ...
            <p><?= $dictionary[$language . '_fly'] ?></p>
          </a>
          <a class=<?php if ($_title == 'Stays') {
                      echo 'current_page';
                    } else {
                      echo 'menu_item';
                    } ?> href=<?= 'stays/?language=' . $language ?>>
            ...
            <p><?= $dictionary[$language . '_overnatninger'] ?></p>
          </a>
          <a class=<?php if ($_title == 'Car') {
                      echo 'current_page';
                    } else {
                      echo 'menu_item';
                    } ?> href=<?= 'car/?language=' . $language ?>>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" class="menu_icons">
            ...
            <p><?= $dictionary[$language . '_bil'] ?></p>
          </a>
          <a class=<?php if ($_title == 'Ferries') {
                      echo 'current_page';
                    } else {
                      echo 'menu_item';
                    } ?> href=<?= 'ferries/?language=' . $language ?>>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" class="menu_icons">
            ...
            <p><?= $dictionary[$language . '_færger'] ?></p>
            <p class="nyhed"><?= $dictionary[$language . '_nyhed'] ?></p>
          </a>
          <a class=<?php if ($_title == 'Things to do') {
                      echo 'current_page';
                    } else {
                      echo 'menu_item';
                    } ?> href=<?= 'things_to_do/?language=' . $language ?>>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" class="menu_icons">
            ...
            <p><?= $dictionary[$language . '_oplevelser'] ?></p>
          </a>
          <a class=<?php if ($_title == 'Holidays') {
                      echo 'current_page';
                    } else {
                      echo 'menu_item';
                    } ?> href=<?= 'holidays/?language=' . $language ?>>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" class="menu_icons">
            ...
            <p><?= $dictionary[$language . '_pakkerejser'] ?></p>
          </a>
        </div>
        <div id="menu_bot">
          <a class=<?php if ($_title == 'Explore') {
                      echo 'current_page';
                    } else {
                      echo 'menu_item';
                    } ?> href=<?= 'explore/?language=' . $language ?>>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" class="menu_icons">
          ...
          <a class=<?php if ($_title == 'Rejserestriktioner') {
                      echo 'current_page';
                    } else {
                      echo 'menu_item';
                    } ?> href=<?= 'rejserestriktioner/?language=' . $language ?>>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" class="menu_icons">
        ...
        <div id="menu_footer">
          <a class=<?php if ($_title == 'Trips') {
                      echo 'current_page';
                    } else {
                      echo 'menu_item';
                    } ?> href=<?= 'trips/?language=' . $language ?>>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" class="menu_icons">
    ...
    <nav>
      ...
      <div class="flex">
        ...
        <div class="toggle_700_flex" id="login-button">
          ...
          session_start();
          if (!$_SESSION) {
            echo ' <svg id="man" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
          ...
          if ($_SESSION) {
            echo '<img class="profile_pic" src="img/profile-img.jpg" alt="profiel pic">
        ...
        <div id="admin_dropdown">
          <a href="todo">Your Trips</a>
          <a href="todo">Help/FQA</a>
          <a href=<?= 'admin/?language=' . $language ?>>Your Account</a>
          <a href="/bridge_signout.php""><button type=" button" class=" button_type_3">Sign Out</button></a>
        </div>
        ...
        <div class="flex">
          ...
          <?php
          if ($language == 'en') {
            echo '<a id="dansk" href="' . $_current_page . '/?language=dk" class="orange-hover toggle_700">Dansk</a>';
          }
          if ($language == 'dk') {
            echo '<a id="dansk" href="' . $_current_page . '/?language=en" class="orange-hover toggle_700">English</a>';
          }
