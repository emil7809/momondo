  ...
  <div id="menu_container" onclick="toggle_menu()">
    <div id="menu">
      <div id="menu">
        ...
        <div id="menu_mid">
          <a class="menu_item" href=<?= '/?language=' . $language ?>>
            <svg class="menu_icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
          ...
          <a class="menu_item" href=<?= 'stays/?language=' . $language ?>>
          ...
          <a class="menu_item" href=<?= 'car/?language=' . $language ?>>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" class="menu_icons">
          ...
          <a class="menu_item" href=<?= 'ferries/?language=' . $language ?>>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" class="menu_icons">
          ...
          <a class="menu_item" href=<?= 'things_to_do/?language=' . $language ?>>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" class="menu_icons">
          ...
          <a class="menu_item" href=<?= 'holidays/?language=' . $language ?>>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" class="menu_icons">
        ...
        <div id="menu_bot">
          <a class="menu_item" href=<?= 'explore/?language=' . $language ?>>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" class="menu_icons">
          ...
          <a class="menu_item" href=<?= 'rejserestriktioner/?language=' . $language ?>>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" class="menu_icons">
        ...
        <div id="menu_footer">
          <a class="menu_item" href=<?= 'trips/?language=' . $language ?>>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" class="menu_icons">
