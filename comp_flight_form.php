<div class="center_container">
  <div id="trip_details">
    <div>
      <p><?= $dictionary[$language . '_return'] ?></p>
    ...
    <div>
      <p><?= $dictionary[$language . '_adult'] ?></p>
      <svg style="width:1.2rem;fill:white;margin-left:6px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
        <path d="M100 135a4.99 4.99 0 0 1-3.363-1.3l-55-50a5 5 0 1 1 6.727-7.399L100 123.243L151.637 76.3a5 5 0 1 1 6.726 7.399l-55 50A4.986 4.986 0 0 1 100 135z">
        </path>
      </svg>
    ...
    <div id="from_to_container">
      <div id="from-container">
        <div class="input-caontainer">
          ...
          <input id="from-input" type="text" placeholder=<?= $dictionary[$language . '_from'] ?> oninput="show_from_results()">
        </div>
      ...
      <div id="to-container">
        <div class="input-caontainer">
          ...
          <input id="to-input" type="text" placeholder=<?= $dictionary[$language . '_to'] ?> oninput="show_to_results()">
        </div>
